...
public class ChatScreen extends Screen {
    ...
    private void updateUsageInfo() {
        ...
        this.suggestions = null;
        if (this.hasEdits && this.mc.gameSettings.autoSuggestCommands) {
            this.showSuggestions();
        }
    ...
    public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
        ...
        if (this.suggestions != null && this.suggestions.mouseScrolled(p_mouseScrolled_5_)) {
            ...
            this.mc.ingameGUI.getChatGUI().func_194813_a(p_mouseScrolled_5_);
            return true;
        }
    }
    ...
    public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
        if (this.suggestions != null && this.suggestions.mouseClicked((int) p_mouseClicked_1_, (int) p_mouseClicked_3_, p_mouseClicked_5_)) {
            ...
            if (p_mouseClicked_5_ == 0) {
                ITextComponent itextcomponent = this.mc.ingameGUI.getChatGUI().getTextComponent(p_mouseClicked_1_, p_mouseClicked_3_);
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        fill(2, this.height - 14, this.width - 2, this.height - 2, this.mc.gameSettings.func_216839_a(Integer.MIN_VALUE));
        ...
        ITextComponent itextcomponent = this.mc.ingameGUI.getChatGUI().getTextComponent((double) p_render_1_, (double) p_render_2_);
    ...
    private void fillNodeUsage(TextFormatting p_195132_1_) {
        ...
        Map<CommandNode<ISuggestionProvider>, String> map = this.mc.player.connection.func_195515_i().getSmartUsage(suggestioncontext.parent, this.mc.player.connection.getSuggestionProvider());
    ...
    class SuggestionsList {
        ...
        public boolean mouseScrolled(double p_198498_1_) {
            int i = (int) (ChatScreen.this.mc.mouseHelper.getMouseX() * (double) ChatScreen.this.mc.mainWindow.getScaledWidth() / (double) ChatScreen.this.mc.mainWindow.getWidth());
            int j = (int) (ChatScreen.this.mc.mouseHelper.getMouseY() * (double) ChatScreen.this.mc.mainWindow.getScaledHeight() / (double) ChatScreen.this.mc.mainWindow.getHeight());
