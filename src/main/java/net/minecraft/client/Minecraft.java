...
import net.lax1dude.eaglercraft.opengl.ext.deferred.texture.MetalsLUT;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener, AutoCloseable {
    ...
    public static byte[] memoryReserve = new byte[2097152];
    private static int cachedMaximumTextureSize = -1;
    private final VFile2 fileResourcepacks;
    ...
    public String currentWorldFolderName;
    ...
    private final Queue<Runnable> field_213275_aU = new java.util.LinkedList<>();
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        this.packFinder = new DownloadingPackFinder(new VFile2(this.gameDir, "server-resource-packs"), gameConfig.folderInfo.getAssetsIndex());
        ...
        this.sessionService = (new YggdrasilAuthenticationService(EaglercraftUUID.randomUUID().toString())).createMinecraftSessionService();
        this.session = new Session(EaglerProfile.username, "1", "-", "legacy");
            ...
            try {
                ...
                while (this.running) {
                    ...
                    try {
                        ...
                        if (this.pendingWorldUnload != null) {
                            Runnable r = this.pendingWorldUnload;
                            this.pendingWorldUnload = null;
                            r.run();
                        }
                ...
                net.lax1dude.eaglercraft.internal.PlatformRuntime.printJSExceptionIfBrowser(reportedexception);
                this.addGraphicsAndWorldToCrashReport(reportedexception.getCrashReport());
                this.freeMemory();
                LOGGER.fatal("Reported exception thrown!", (Throwable) reportedexception);
                this.displayCrashReport(reportedexception.getCrashReport());
            } catch (Throwable throwable1) {
                net.lax1dude.eaglercraft.internal.PlatformRuntime.printJSExceptionIfBrowser(throwable1);
    ...
    private void init() {
        ...
        this.mainWindow = new MainWindow(this, screensize, "Minecraft " + SharedConstants.getVersion().getName(), "Minecraft");
        ...
        this.skinManager = new SkinManager(this.textureManager, new VFile2(this.fileAssets, "skins"), this.sessionService);
        this.saveFormat = new SaveFormat(net.peyton.eagler.fs.WorldsDB.newVFile(""), net.peyton.eagler.fs.WorldsDB.newVFile("backups"), this.dataFixer);
        ...
        this.resourceManager.addReloadListener(new net.lax1dude.eaglercraft.opengl.ext.deferred.ShaderPackInfoReloadListener());
        this.resourceManager.addReloadListener(PBRTextureMapUtils.blockMaterialConstants);
        this.resourceManager.addReloadListener(new TemperaturesLUT());
        this.resourceManager.addReloadListener(new MetalsLUT());
    ...
    public void shutdownMinecraftApplet() {
        try {
            ...
            boolean flag = this.isIntegratedServerRunning();
            if (this.world != null) {
                this.world.sendQuittingDisconnectingPacket();
            }
            if (flag) {
    ...
    private void runGameLoop(boolean renderWorldIn) {
        net.lax1dude.eaglercraft.internal.PlatformWebRTC.runScheduledTasks();
        ...
        if (net.lax1dude.eaglercraft.Display.wasResized()) {
            this.updateWindowSize();
        }
        this.profiler.startSection("tick");
        this.mouseHelper.tick();
        if (renderWorldIn) {
        ...
        ++this.fpsCounter;
        boolean flag = this.isSingleplayer() && (this.currentScreen != null && this.currentScreen.isPauseScreen() || this.loadingGui != null && this.loadingGui.isPauseScreen()) && !(this.integratedServer != null && this.integratedServer.getPublic());
        ...
        while (Util.milliTime() >= this.debugUpdateTime + 1000L) {
            ...
            this.debugUpdateTime = Util.milliTime();
            this.fpsCounter = 0;
    ...
    public void displayInGameMenu(boolean pauseOnly) {
        if (this.currentScreen == null) {
            boolean flag = this.isSingleplayer() && !(this.integratedServer != null && this.integratedServer.getPublic());
            if (flag) {
    ...
    public void runTick() {
        ...
        if (this.getConnection() != null) {
            net.minecraft.network.NetworkManager nm = this.getConnection().getNetworkManager();
            if (nm != null) {
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        this.currentWorldFolderName = folderName;
        net.lax1dude.eaglercraft.sp.SingleplayerServerController.launchEaglercraftServer(
                this.gameDir.getPath(), folderName, worldName,
                Math.max(gameSettings.renderDistanceChunks, 2), worldSettingsIn);
        this.displayGuiScreen(new net.lax1dude.eaglercraft.sp.gui.GuiScreenIntegratedServerBusy(
                new net.lax1dude.eaglercraft.sp.gui.GuiScreenSingleplayerConnecting(
                        new net.minecraft.client.gui.screen.MainMenuScreen(), "Connecting to " + folderName),
                "singleplayer.busy.startingIntegratedServer", "singleplayer.failed.startingIntegratedServer",
                () -> net.lax1dude.eaglercraft.sp.SingleplayerServerController.isWorldReady(), (t, u) -> {
            Minecraft.this.displayGuiScreen(
                    net.lax1dude.eaglercraft.sp.gui.GuiScreenIntegratedServerBusy.createException(
                            new net.minecraft.client.gui.screen.MainMenuScreen(),
                            ((net.lax1dude.eaglercraft.sp.gui.GuiScreenIntegratedServerBusy) t).failMessage, u));
        }));
    }
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        if (!this.integratedServerIsRunning) {
            AuthenticationService authenticationservice = new YggdrasilAuthenticationService(EaglercraftUUID.randomUUID().toString());
            MinecraftSessionService minecraftsessionservice = authenticationservice.createMinecraftSessionService();
            GameProfileRepository gameprofilerepository = authenticationservice.createProfileRepository();
            PlayerProfileCache playerprofilecache = new PlayerProfileCache(gameprofilerepository, new VFile2(this.gameDir, MinecraftServer.USER_CACHE_FILE.getName()));
    ...
    public void scheduleWorldUnload(Screen savingScreen, Screen nextScreen) {
        this.displayGuiScreen(savingScreen);
        this.pendingWorldUnload = () -> {
            this.func_213231_b(savingScreen);
            this.displayGuiScreen(nextScreen);
        };
    }
    ...
    public void func_213231_b(Screen screenIn) {
        ...
        this.integratedServer = null;
        this.currentWorldFolderName = null;
    ...
    private void updateWorldRenderer(ClientWorld worldIn) {
        if (this.worldRenderer != null) {
    ...
    public static boolean isGuiEnabled() {
        return instance == null || instance.gameSettings == null || !instance.gameSettings.hideGUI;
    }

    public static boolean isFancyGraphicsEnabled() {
        return instance != null && instance.gameSettings != null && instance.gameSettings.fancyGraphics;
    }

    public static boolean isAmbientOcclusionEnabled() {
        return instance != null && instance.gameSettings != null && instance.gameSettings.ambientOcclusionStatus != AmbientOcclusionStatus.OFF;
    }
    ...
    public VFile2 getFileResourcePacks() {
